...
module.exports = {
  ...
  // E.g. maxWorkers: 10% will use 10% of your CPU amount + 1 as the maximum worker number. 5
  ...
  // The paths to modules that run some code to configure or set up the testing 5
  ...
  // testRegex: ['/__tests__/src/.*\\.spec\\.js$'],
